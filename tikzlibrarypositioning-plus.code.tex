...
\def\tikz@lib@place@handle@#1#2#3#4#5#6{%
  ...
  \ifpgfutil@in@
    ...
    \pgfmathsetmacro\pgf@tempa{(\pgf@tempa)*#3}%
    \pgfmathsetmacro\pgf@tempb{(\pgf@tempb)*#4}%
    \pgfmathsetmacro\tikz@lib@temp{(\tikz@lib@temp)*#6}%
    \edef\pgf@marshal{\noexpand\tikz@lib@place@handle@{\pgf@temp}{#2}{\pgf@tempa}{\pgf@tempb}{#5}{\tikz@lib@temp}}%
    \pgf@marshal
  \else
    \def\tikz@anchor{#2}%
