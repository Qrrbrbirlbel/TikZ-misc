\let\tikz@lib@nf@textheight\pgfutil@empty
\let\tikz@lib@nf@textdepth\pgfutil@empty
%\let\tikz@lib@nf@textwidth\pgfutil@empty
\tikzset{
  Minimum Width/.code={%
      ...
      prefix after command={%
        \pgfextra
          \pgfinterruptpath
            ...
            \tikz@atend@picture\expandafter\expandafter\expandafter{\expandafter\tikz@atend@picture\expandafter\tikz@lib@nf@save\expandafter{\pgfpictureid}{#1}{width}}
          \endpgfinterruptpath
        \endpgfextra
      }%
    }%
      ...
      prefix after command={%
        \pgfextra
          \pgfinterruptpath
            ...
            \expandafter\expandafter\expandafter\gdef\expandafter\expandafter\expandafter
            \tikz@atend@picture\expandafter\expandafter\expandafter{\expandafter\tikz@atend@picture\expandafter\tikz@lib@nf@save\expandafter{\pgfpictureid}{#1}{height}}
          \endpgfinterruptpath
        \endpgfextra
      }%
    }%
...
%  Text Width/.code= \edef\tikz@lib@nf@textwidth{#1},
}

\def\tikz@lib@nf@text@#1#2#3{%
    \expandafter\ifx\csname tikz@lib@nf@#3\endcsname\pgfutil@empty\else
      \pgfutil@ifundefined{\pgfpictureid @\csname tikz@lib@nf@#3\endcsname @#3}{%
        \expandafter\xdef\csname\pgfpictureid @\csname tikz@lib@nf@#3\endcsname @#3\endcsname{\the#1#2}%
      }{%
        \ifdim\csname\pgfpictureid @\csname tikz@lib@nf@#3\endcsname @#3\endcsname<#1#2
          \expandafter\xdef\csname\pgfpictureid @\csname tikz@lib@nf@#3\endcsname @#3\endcsname{\the#1#2}%
        \else
          #1#2=\csname\pgfpictureid @\csname tikz@lib@nf@#3\endcsname @#3\endcsname\relax
        \fi
      }%
      \edef\tikz@temp{\noexpand\tikz@lib@nf@save{\pgfpictureid}{\csname tikz@lib@nf@#3\endcsname}{#3}}%
      \expandafter\expandafter\expandafter\gdef\expandafter\expandafter\expandafter
